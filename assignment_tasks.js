...
const array = [1, null, undefined, 18, -19, NaN, "12", [1, 2], { ob: "lala" }, 897,13,true, 4];
...
const onlyNumbers = deleteInvalids(array);
...
console.log(password({ name: 'rahat' ,birthYear:2004, siteName: 'facebook' }));
